...
class Joueur:
    ...
    def actualiser(self):
        ...
        pygame.draw.rect(ecran, (255,0,0), (self.x, self.y, self.largeur, self.hauteur))
...
class Plateforme:
    ...
    def actualiser(self):
        pygame.draw.rect(ecran, (0,0,0), (self.hitbox_apparence))
...
while run:
    ...
    if jeu == True and jouer == True :
        ...
        #pas de mouvement
            ...
            if(joueur.right):
                joueur_image = image_stand

            else:
                joueur_image = image_standL
        ...
        if (keys[pygame.K_DOWN]):
            ...
            if(not joueur.saut and joueur.y == p1.y - 80):
                joueur.hauteur = 40
                joueur.y = p1.y - 40
                joueur_image = pygame.image.load("img/herobackground/hero/crouch/crouchR.png")
        else:
            joueur_baisse = False
            joueur.hauteur = 80
